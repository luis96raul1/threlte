...
} from "./chunk-R7H63GAF.js";
import {
  derived,
  readable,
  writable
} from "./chunk-W44UHIGS.js";
import {
  SvelteComponentDev,
  action_destroyer,
  add_location,
...
var HierarchicalObject = class extends SvelteComponentDev {
  ...
  set onChildMount(onChildMount) {
    this.$$set({ onChildMount });
    flush();
  }
  get onChildDestroy() {
    return this.$$.ctx[4];
  }
  set onChildDestroy(onChildDestroy) {
    this.$$set({ onChildDestroy });
    flush();
  }
  get parent() {
    return this.$$.ctx[1];
...
create_custom_element(HierarchicalObject, { "object": {}, "onChildMount": {}, "onChildDestroy": {}, "parent": {} }, ["default"], [], true);
...
create_custom_element(SceneGraphObject, { "object": {} }, ["default"], [], true);
...
function add_css(target) {
  append_styles(target, "svelte-o3oskp", "canvas.svelte-o3oskp{display:block}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQ2FudmFzLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUF5SUUsb0JBQU8sQ0FDTCxPQUFPLENBQUUsS0FDWCIsIm5hbWVzIjpbXSwic291cmNlcyI6WyJDYW52YXMuc3ZlbHRlIl19 */");
}
...
var Canvas = class extends SvelteComponentDev {
  ...
  set colorManagementEnabled(colorManagementEnabled) {
    this.$$set({ colorManagementEnabled });
    flush();
  }
  get colorSpace() {
    return this.$$.ctx[6];
  ...
  set rendererParameters(rendererParameters) {
    this.$$set({ rendererParameters });
    flush();
  }
  get shadows() {
    return this.$$.ctx[10];
  ...
  set toneMapping(toneMapping) {
    this.$$set({ toneMapping });
    flush();
  }
  get useLegacyLights() {
    return this.$$.ctx[13];
  }
  set useLegacyLights(useLegacyLights) {
    this.$$set({ useLegacyLights });
    flush();
  }
  get autoRender() {
    return this.$$.ctx[14];
  ...
  set ctx(value) {
    throw new Error("<Canvas>: Cannot set read-only property 'ctx'");
  }
};
create_custom_element(Canvas, { "colorManagementEnabled": { "type": "Boolean" }, "colorSpace": {}, "dpr": {}, "renderMode": {}, "rendererParameters": {}, "shadows": {}, "size": {}, "toneMapping": {}, "useLegacyLights": {}, "autoRender": { "type": "Boolean" } }, ["default"], ["ctx"], true);
...
create_custom_element(DisposableObject, { "object": {}, "dispose": {} }, ["default"], [], true);
...
var T = class extends SvelteComponentDev {
  ...
  set ref(publicRef) {
    this.$$set({ ref: publicRef });
    flush();
  }
};
create_custom_element(T, { "is": {}, "args": {}, "attach": {}, "manual": {}, "makeDefault": {}, "dispose": {}, "ref": {} }, ["default"], [], true);
var T_default = T;
...
//# sourceMappingURL=chunk-X7Z6HGZR.js.map
